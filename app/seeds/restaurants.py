...
def seed_restaurants():
    ...
    restaurant_2 = Restaurant(
        ...
        description="The restaurant that everyone is talking about. Bobbie's Burritos bursted onto the scene with creative, delicious, and unique tex-mex dishes!",
    ...
    restaurant_3 = Restaurant(
        ...
        description="This is seed data that doesn't have a description yet!",
