  ...
  return (
    <div className="review-card">
      ...
      <div className="review-card-stars">
        {review.stars >= 1 ? (
          <IoIosStar className="review-card-star" />
        ) : (
          <IoIosStar className="review-card-star-empty" />
        )}
        {review.stars >= 2 ? (
          <IoIosStar className="review-card-star" />
        ) : (
      ...
      {user && user.username === review.reviewer ? (
        <div>
          <OpenModalButton
            modalComponent={
              <ReviewModal review={review} restaurant={restaurant} />
            }
            buttonText={`Update Review`}
            className={"review-card-update"}
          />
          <OpenModalButton
            modalComponent={
              <DeleteReviewModal review={review} restaurantId={restaurant.id} />
            }
